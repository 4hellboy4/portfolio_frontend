  ...
  return (
    <section>
      ...
      <div className="info">
        ...
        <p>Publication Date: <span>{comicInfo ? formatDistanceToNow(new Date(comicInfo.year, comicInfo.month - 1, comicInfo.day), { addSuffix: true }) : ''}</span></p>
      </div>
      <img id="comic-img" alt="Comic image will appear here" src={comicInfo?.img} />
    </section>
  );
};
